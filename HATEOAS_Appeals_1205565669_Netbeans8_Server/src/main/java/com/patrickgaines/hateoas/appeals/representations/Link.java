...
public class Link {
    ...
    public String getRelValue() {
        LOG.info("Retrieving the rel attribute value {}", rel);
        return rel;
    }
    ...
    public URI getUri() {
        ...
        try {
            ...
            LOG.info("Retrieving the uri attribute value {}", local_uri);
            return local_uri;
    ...
    public String getMediaType() {
        LOG.info("Retrieving the media type attribute value {}", mediaType);
        return mediaType;
    }
}
